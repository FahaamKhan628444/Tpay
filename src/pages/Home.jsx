...
export default function Home() {
  ...
  <Marquee speed={50} gradient={false} className="bg-blue-100 py-2 text-sm">
    TimelyPay does not charge any payments except our subscriptions.  We are just a Payment Reminder Software Company.
  </Marquee>
</div>
      {/* Hero Section */}
      <div className="h-screen w-full bg-gradient-to-r from-white to-gray-300 flex flex-col items-center justify-center text-center p-4">
        ...
        <p className="text-base sm:text-lg text-gray-600 mb-6">
          Make your bills paid on time with one of the best payment reminder software in    <span>🇮🇳</span>
        </p>
